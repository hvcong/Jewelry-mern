...
function Slider() {
  ...
  return (
    <div className="slider-container">
      ...
      >
        ...
        >
          <div className="slider__item-content">
            ...
            <div className="slider__item-heading">ĐỒNG HỒ GALA-WATCH </div>
            <p className="slider__item-sub-text">
              Chuyên cung cấp các đồng hồ thời trang theo xu hướng hiện đại
            </p>
            <Link to="/" className="slider__item-link">
              LIÊN HỆ
            </Link>
          </div>
        </div>
      ...
      <div
        className="slider__btn slider__btn-prev d-none d-sm-flex add-animation"
        onClick={() => {
      ...
      <div
        className="slider__btn slider__btn-next d-none d-sm-flex add-animation"
        onClick={() => {
          setCurrentSlider(currentSlider < maxSlider ? currentSlider + 1 : 1);
        }}
      >
      ...
      <div className="slider__dot">
        <span
          className={
            currentSlider === 1 ? "slider__dot-item active" : "slider__dot-item"
          }
          onClick={() => setCurrentSlider(1)}
        ></span>
        <span
          className={
            currentSlider === 2 ? "slider__dot-item active" : "slider__dot-item"
          }
