        ...
        <Modal setIsOpen={setIsOpenMenuModal}>
          <div className="menu__modal-container">
            <div className="menu__search">
              ...
              <div className="menu__search-result d-none">result container</div>
            </div>
              ...
              <ul className="menu__body-list">
                ...
                <li className="menu__body-item">
                  <div className="menu__body-item-sub-group">
                    ...
                    <span
                      className="material-icons menu__body-icon"
                      onClick={(e) => {
                        let parent = findParentElement(
                          e.target,
                          ".menu__body-item"
                        );
                        if (parent) {
                  ...
                  <div className="menu__body-sub-list">
                    <Link
                      to="/products/ring"
                      className="menu__body-link menu__body-sub-link"
                      onClick={() => {
                        setIsOpenMenuModal(false);
                      }}
                    >
            ...
            <div className="menu__social-media">
              <Link to="/" className="menu__social-media-link">
                ...
                <span className="menu__social-media-text-sub">
                  Follow on Facebook
                </span>
              </Link>
              <Link to="/" className="menu__social-media-link">
